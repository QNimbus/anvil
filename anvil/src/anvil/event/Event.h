...
namespace Anvil::Events
{
    ...
    */
    ...
    public:
        ...
        virtual bool InCategory(EventCategory category) const { return GetCategoryFlags() & static_cast<uint32_t>(category); }
        virtual bool InCategory(uint32_t    categories) const { return GetCategoryFlags() & categories; }
    ...
    inline uint32_t operator| (EventCategory lhs, EventCategory rhs) {
    ...
    inline uint32_t operator| (uint32_t lhs, EventCategory rhs) {
